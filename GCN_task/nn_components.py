...
def ann(input, params, out_dims=None, dropout_keep_prob=1.0, trainable=True, **kwargs):
...
def attend_on_other(input, params, filters=None, dropout_keep_prob=1.0, trainable=True, **kwargs):
    ...
    h_mean, h_var = tf.nn.moments(h_flat, axes=0)
    #h_flat_norm = h_flat
    h_flat_norm = tf.nn.l2_normalize(h_flat)
    #h_flat_norm = (h_flat - h_mean)/h_var
...
def attend_on_other_recurrent(input, params, filters=None, dropout_keep_prob=1.0, trainable=True, **kwargs):
