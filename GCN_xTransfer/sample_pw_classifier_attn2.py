...
class PWClassifier(object):
    def __init__(self, layer_specs, layer_args, train_data, learning_rate, params_preTrain, pn_ratio, outdir):
        ...
        with self.graph.as_default():
            ...
            with tf.name_scope(name):
                ...
                self.output_conv_p2, _ = layer_fn(input2, params, None, **args)
            ...
            with tf.name_scope(name):
                ...
                self.output_conv2_p2, _ = layer_fn(input2, params, None, **args)
            ...
            with tf.name_scope(name):
                self.feats_attention, self.raw_attention, self.output_attention, params = layer_fn(input_att_1, None, params_preTrain[i], **args)
    ...
    def weights(self, data):
        ...
        return [{"wt_conv_center":output_list[0], "wt_conv_neighb":output_list[1]},
                ...
                {"wt_attention":output_list[4]},
                {"wt_dense":output_list[5]}]
