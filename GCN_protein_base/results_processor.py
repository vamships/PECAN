...
class ResultsProcessor:
    def __init__(self):
        ...
        self._predictions = {"train": None, "test": None, "val": None}
        self._losses = {"train": None, "test": None, "val": None}
        self._labels = {"train": None, "test": None, "val": None}
    ...
    def process_results(self, exp_specs, data, model, name):
        ...
        metrics = ["loss_train", "loss_val", "loss_test", "auprc_train", "auprc_val", "auprc_test"]
        _headers = []
        _results = []
    ...
    def loss_val(self, data, model, name):
        return self.loss(data, model, "val", name + "_val")
    ...
    def auprc_val(self, data, model, name):
        return self.auprc(data, model, "val", name + "_val")
